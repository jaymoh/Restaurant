...
public class NavDrawerBase extends ListActivity {
	//193.168.42.76
 ...
 // used to store app title
	...
	//Internet connectivity status check 
			...
			{
				AlertDialog.Builder builder=new AlertDialog.Builder(NavDrawerBase.this);
				LayoutInflater inflater=LayoutInflater.from(NavDrawerBase.this);
